...
def parse_gdscript(arg_file_path):
    ...
    for line in lines:
        if line.startswith("func"):
            function_line_split = line.lstrip("func(")
            function_line_split = function_line_split.split(")")
            function_line_arguments = function_line_split[1]
            


def parse_gdscript_gpt(file_path):
